...
: <http://github.com/arcatelier/prompts/blob/master/prompts/very-witty-pick-up-lines.prompt>
...
-   Design patterns used:
    -   [mulitplex pattern](http://github.com/arcatelier/prompt-engineering-patterns/blob/master/patterns/multiplex-answers.org)
    -   [### pattern](http://github.com/arcatelier/prompt-engineering-patterns/blob/master/patterns/use-separator-between-examples.org)
    -   [prelude pattern](http://github.com/arcatelier/prompt-engineering-patterns/blob/master/patterns/reflective-description-of-task.org)
